...
const Dashboard = ({ assessment, learningPath, onSelectFeature, onBack }) => {
  const features = [
    {
      id: 'practice',
        ...
        <div className="bg-space-light/30 backdrop-blur-sm rounded-3xl shadow-xl p-8 mb-12 border border-periwinkle/20 animate-slide-up">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3 group">
              <div className="w-12 h-12 bg-gradient-to-br from-periwinkle/20 to-dusty-rose/20 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="bg-space-light/30 backdrop-blur-sm rounded-3xl shadow-xl p-8 border border-periwinkle/20 animate-slide-up delay-700">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {learningPath.topics.map((topic, index) => (
              <div
                key={index}
                className="bg-gradient-to-r from-pale-pink/20 to-periwinkle/20 rounded-xl p-4 border-l-4 border-dusty-rose hover:border-periwinkle transition-colors duration-300"
              >
